...
- "novedades": Array de strings. Captura TODOS los temas mencionados: presentaciones realizadas, interés del cliente en productos, temas pendientes o sin novedad. Ejemplo de pendiente: "Helados 🍦: tema pendiente; sin novedades y sin ventas activas". IMPORTANTE: NO incluyas en novedades los problemas de stock/disponibilidad (esos van en stock_disponibilidad). Solo incluye aquí: presentaciones de catálogo, interés del cliente en nuevos productos, y temas pendientes de seguimiento. Array vacío [] SOLO si no se menciona absolutamente ningún tema.
...
- "objeciones": Array de strings. SIEMPRE genera DOS tipos de objeción cuando apliquen — (a) objeción de precio: menciona qué producto, qué pide el cliente y la referencia comparativa (ej: cooperativa); (b) impacto comercial del stock: si hay productos sin stock y el cliente busca alternativas o muestra malestar, añade un ítem separado que indique qué productos afectan y cuál es el riesgo (ej: "Falta de stock en picantones 🍗 y menudos 🥩 genera malestar y búsqueda de alternativas"). Redacta cada objeción como una frase profesional independiente. Array vacío [] solo si no hay ninguna objeción ni malestar.
